            ...
            <form onSubmit={handleSubmit} aria-required={true}>
              <div className="w-full min-[800px]:flex block pb-3">
                ...
                <div className="w-[100%] min-[800px]:w-[50%]">
                  ...
                  <input
                    type="text"
                    className={`${styles.input} !w-[95%] bg-white mb-1 min-[800px]:mb-0`}
                    required
                    value={email}
              ...
              <div className="w-full min-[800px]:flex block  pb-3">
                ...
                <div className="w-[100%] min-[800px]:w-[50%]">
                  ...
                  <input
                    type="number"
                    className={`${styles.input} !w-[95%] bg-white `}
                    required
                    value={zipCode}
      ...
      <div className="w-full bg-white h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10">
        <div className="flex items-center">
          <img
            ...
            alt=""
          />
          <h5 className="pl-5 font-[600]">Mohsin Ali</h5>
        </div>
  ...
  return (
    <div className="w-full px-5">
      ...
      <div className="w-full bg-white h-[70px] rounded-[4px] flex items-center px-3 shadow justify-between pr-10">
        ...
        <div className="pl-8 flex items-center">
          <h6>500 Erdman Passage, New Zoietown, Paraguay</h6>
        </div>
        <div className="pl-8 flex items-center">
          <h6>(213) 840-9416</h6>
        </div>
